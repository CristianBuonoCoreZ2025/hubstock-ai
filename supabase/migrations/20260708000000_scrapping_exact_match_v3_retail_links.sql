-- ============================================================================
-- PASO 1 v3: Match exacto/fuzzy + vinculo retail + alias + snapshot + imagen
-- ============================================================================
-- Agrega a la funcion scrapping_apply_exact_catalog_matches:
--   1. Vinculo en catalog_retail_links (retailer + external_ref -> maestro)
--   2. Alias en catalog_product_aliases (nombre scrapeado como alias)
--   3. Snapshot en catalog_retail_snapshots (precio, titulo, imagen)
--   4. Actualizacion de thumb_url del maestro si esta vacio
--
-- Antes solo actualizaba default_reference_price y borraba scrapping.
-- Ahora los productos encontrados quedan realmente vinculados al retail.
-- ============================================================================
...
begin
  ...
  -- Actualizar thumb_url del maestro si esta vacio y tenemos imagen
  update public.catalog_products cp
...
comment on function public.scrapping_apply_exact_catalog_matches() is
  'Paso 1 v3: match exacto + fuzzy por marca+similitud. Actualiza precio maestro, crea vinculo retail, alias, snapshot e imagen.';
