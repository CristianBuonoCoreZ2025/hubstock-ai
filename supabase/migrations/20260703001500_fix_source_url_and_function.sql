-- ============================================================================
-- Migracion: Fix definitivo de scrapping_create_new_products_all.
--
-- Problema:
--   catalog_products.source_product_url tiene indice unico.
--   La funcion insertaba c.product_url como source_product_url, pero multiples
--   filas de scrapping comparten la misma URL (mismo producto en distintos
--   listados de Jumbo), causando error 23505.
--
-- Fix:
--   No se inserta source_product_url en catalog_products para productos
--   creados desde scrapping. La URL ya esta en catalog_retail_links y
...
begin
  ...
  -- FIX: No se inserta source_product_url porque multiples filas de scrapping
  -- pueden compartir la misma URL, violando el indice unico.
