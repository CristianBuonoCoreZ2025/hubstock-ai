-- ============================================================================
-- Migracion: Corregir retailer hardcodeado en scrapping_create_new_products_all.
--
-- Problema:
--   La funcion tenia 'lider' hardcodeado en el PASO 6 donde crea
--   retail_taxonomy_mappings para combinaciones de seccion/categoria
--   sin mapping previo. Como resultado, productos de otros retailers
--   (ej: jumbo) nunca obtenian winner_category_id/winner_section_id,
--   todos iban a skipped=processed_rows y ninguno se creaba.
--
-- Cambios:
--   1. PASO 4: _tmp_product_taxonomy ahora incluye retailer.
--   2. PASO 5: _tmp_new_taxonomy ahora incluye retailer.
--   3. PASO 6: Usa nt.retailer dinamico en lugar de 'lider' hardcodeado.
-- ============================================================================
