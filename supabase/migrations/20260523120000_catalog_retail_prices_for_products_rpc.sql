-- Último precio capturado por cadena (snapshots) para cada maestro del catálogo vinculado en catalog_retail_links.
...
comment on function public.catalog_retail_prices_for_products(uuid[]) is
  'Último precio por cadena (snapshots) para productos maestros con vínculo en catalog_retail_links.';
