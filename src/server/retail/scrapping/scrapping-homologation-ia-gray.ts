...
export async function processHomologationGrayIaQueue(
  ...
  const list = rows ?? []
  const summary: HomologGrayIaSummary = {
    processed: 0,
    userReview: 0,
    tentativeAi: 0,
    rejected: 0,
